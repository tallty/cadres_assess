...
export class StepThree extends Component {
	render() {
        ...
        <div className={css.table_cell_one}><label>姓名:胡国胜</label><label>职务:计算机应用系主任</label><Button className={css.print_btn_one} type="primary">打印表格</Button></div>
        ...
        <div className={css.table_content}>
          ...
          <div><Button className={css.print_btn_two} type="primary">打印表格</Button></div>
        </div>
      </div>
		);
	}
